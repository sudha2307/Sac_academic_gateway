...
# Configurations
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL') or 'postgresql://postgres:RtYGDFoOswpAMnMxFrWbnJLleHpTKtUB@postgres.railway.internal:5432/railway'
